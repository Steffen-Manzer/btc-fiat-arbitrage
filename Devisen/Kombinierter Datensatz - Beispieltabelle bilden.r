...
sampleTimeframe <- c(as.POSIXct("2020-01-27 12:00:00", tz="UTC"), as.POSIXct("2020-01-27 12:01:00", tz="UTC"))

# Beispieldaten laden
combined <- read_fst("Cache/forex-combined/eurusd/tick/forex-combined-eurusd-tick-2020-01.fst",
                     as.data.table=TRUE)
