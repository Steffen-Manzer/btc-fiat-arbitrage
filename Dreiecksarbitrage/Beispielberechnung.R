...
# Position 34.200.000 entspricht dem 03.12.2021, 16:03:05
# Position 34.300.000 entspricht dem 06.12.2021, 13:54:23
fst_from <- 34200000L
fst_to <- fst_from + 1e5

data_total <- read_fst(
    path = "Cache/Dreiecksarbitrage/2s/coinbase-usd-eur.fst",
